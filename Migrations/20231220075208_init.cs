    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_shiire_saki_masnter", x => x.shiire_saki_code);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_chumon_jisseki_shiire_saki_masnter_shiire_saki_code",
                        column: x => x.shiire_saki_code,
                        principalTable: "shiire_saki_masnter",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_shiire_master_shiire_saki_masnter_shiire_saki_code",
                        column: x => x.shiire_saki_code,
                        principalTable: "shiire_saki_masnter",
                        principalColumn: "shiire_saki_code",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShiireMasterShiireSakiId = table.Column<string>(type: "character varying(10)", nullable: true),
                    ShiireMasterShiirePrdId = table.Column<string>(type: "character varying(10)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.ShiireMasterShiireSakiId, x.ShiireMasterShiirePrdId, x.shohin_code },
                        principalTable: "shiire_master",
                        principalColumns: new[] { "shiire_saki_code", "shiire_prd_code", "shohin_code" });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShireDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_shiire_jisseki", x => new { x.chumon_code, x.shiire_datetime, x.shiire_saki_code, x.shiire_prd_code, x.shohin_code });
                    table.ForeignKey(
